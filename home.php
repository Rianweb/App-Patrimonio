                     ...
                     <div class="row">
                         <div class="col-md-12">
                             <div class="banner-caption">
                                 <h4>Gerenciador de <em>Patrimônio</em></h4>
                                 <p><strong>Sistema de Controle Patrimonial que visa a facilidade e agilidade na utilização e organização.</strong></p>
 ...
 <section class="top-image">
     <div class="container-fluid">
         <div class="row">
             <div class="col-md-12">
                 <img src="/<?= BASE_URL ?>/assets/images/top-image.jpg" alt="">
 ...
 <section class="left-image">
     <div class="container-fluid">
         <div class="row">
             <div class="col-md-6">
                 <img src="<?= BASE_URL ?>/assets/images/left-image.jpg" alt="">
             </div>
             <div class="col-md-6">
 ...
 <section class="right-image">
     <div class="container-fluid">
         <div class="row">
             ...
             <div class="col-md-6">
                 <img src="<?= BASE_URL ?>/assets/images/right-image.jpg" alt="">
             </div>
         </div>
     </div>
 </section>-->